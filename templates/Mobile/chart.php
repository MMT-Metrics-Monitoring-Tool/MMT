    ...
    <div class="chart-limits">
        ...
        <div>
            ...
            <?php
                ...
                echo $this->Form->control('weekmin', array('type' => 'number', 'value' => $this->request->getSession()->read('chart_limits')['weekmin'])).'&nbsp;&nbsp;&nbsp;';
                echo $this->Form->control('weekmax', array('type' => 'number', 'value' => $this->request->getSession()->read('chart_limits')['weekmax']));
        ...
        <div>
            <div class="limit-label">Year:</div>
              <?php
                echo $this->Form->control('yearmin', array('type' => 'number', 'value' => $this->request->getSession()->read('chart_limits')['yearmin'])).'&nbsp;&nbsp;&nbsp;';
                echo $this->Form->control('yearmax', array('type' => 'number', 'value' => $this->request->getSession()->read('chart_limits')['yearmax']));
...
<div class="chart-gallery">
    ...
    <div class="chart">
        <div id="risksseveritywrapper">
        <?php echo $this->Highcharts->render($risksSeverityChart, 'risksSeverityChart'); ?>
    </div>
    </div>
