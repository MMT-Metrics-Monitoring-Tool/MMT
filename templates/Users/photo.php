    ...
    <fieldset>
        ...
        <table class="cell-align-top">
            <tr>
                ...
                <td class="portrait">
                    <?= $this->Custom->profileImage($this->request->getSession()->read('Auth.User')['id']); ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?= $this->Form->control('image', ['label' => '', 'type' => 'file', 'accept' => 'image/*', 'class' => 'preview']); ?>
                </td>
            </tr>
        </table>
        ...
        if ($this->Custom->hasImage($this->request->getSession()->read('Auth.User')['id'])) {
