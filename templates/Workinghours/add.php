...
<div class="workinghours form large-8 medium-16 columns content float: left">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('duration', array('min' => 0, 'style' => 'width: 35%;'));
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                ?>
                <td >
                    <?= $workinghour->has('member') ? $this->Html->link($workinghour->member->member_name, ['controller' => 'Workinghours', 'action' => 'tasks', $workinghour->member->id]) : '' ?>
                </td>  
...
<td ><?= $workinghour->has('member') ? $this->Html->link($workinghour->member->member_name, ['controller' => 'Members', 'action' => 'view', $workinghour->member->id]) : '' ?></td>
             ...
             * IF (you are the owning user or a senior developer) AND workinghour isn't from previous weeks
             * OR you are an admin or a supervisor
             */
                    //if (( ($workinghour->member->user_id == $this->request->getSession()->read('Auth.User.id') || $senior_developer)
