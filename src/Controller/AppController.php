...
class AppController extends Controller
{
    ...
    public function isAuthorized($user) {
        ...
        // if the user wants to add, edit or delete he has to be a senior developer or supervisor
        // all operations that all senior developers and supervisors can do but developers cant should be here.
        // addmultiple is used in the weeklyreport form
        if ($this->request->getParam('action') === 'add' || $this->request->getParam('action') === 'edit'
            || $this->request->getParam('action') === 'delete' || $this->request->getParam('action') === 'addmultiple') {
